...
#recalc2_in = xr.open_dataset("C:/Users/clark/analysis1/afdrs_fbi_recalc/Recalculated_VIC_Grids/cases_adjusted_kbdi/testing_16dec24/VIC_"+str(year_sel_)+mon_sel_str+day_sel_str+"_recalc_plus20.nc")
...
#recalc2_in = xr.open_dataset("C:/Users/clark/analysis1/afdrs_fbi_recalc/Recalculated_VIC_Grids/cases_wind_spedup/VIC_"+str(year_sel_)+mon_sel_str+day_sel_str+"_recalc_plus5_kbdi40.nc")
#recalc2_in = xr.open_dataset("C:/Users/clark/analysis1/afdrs_fbi_recalc/Recalculated_VIC_Grids/cases_adjusted_kbdi/swvic_testing_jan25/plus40_deeca/VIC_"+str(year_sel_)+mon_sel_str+day_sel_str+"_recalc.nc")
recalc2_in = xr.open_dataset("C:/Users/clark/analysis1/afdrs_fbi_recalc/Recalculated_VIC_Grids/cases_v2024.5/VIC_"+str(year_sel_)+mon_sel_str+day_sel_str+"_recalc.nc")
"""
...
#max_fbi2 = recalc2_in['max_fbi'][1, :,:]
"""
max_recalc_fbi = recalc_file_in['index_1'].max(dim='time', keep_attrs=True)
max_recalc_fbi = max_recalc_fbi.where(max_recalc_fbi>=0)
max_fbi2 = recalc2_in['index_1'].max(dim='time',keep_attrs=True)
max_fbi2 = max_fbi2.where(max_fbi2>=0)
"""
...
"""
def plot_and_compare_fbi(max_fbi1, max_fbi2, areas_shapefile, fc_day):
    fig, axs = plt.subplots(1,3,figsize=(14,5.5), subplot_kw={'projection': ccrs.PlateCarree()})
...
#    norm = pltcolors.BoundaryNorm([0,1,2,3,4,5], cmap_rating.N)
    ...
    cb1 = plt.colorbar(im1, orientation='vertical', fraction=0.058)
...
#    axs[0].set_extent([140.8,144.7,-37.0,-33.8])  #Mallee
    axs[0].set_extent([140.8,144.7,-37.6,-33.8]) #Mallee+Wimmera
...
#    axs[0].set_extent([140.8,146.5,-39,-33.8])   #Western two thirds Vic
#    axs[0].set_extent([140.8,149.9,-39,-33.8])   #All Vic
#    axs[0].set_extent([140.8,142.9,-38.6,-37.1])  #Far southwest
#    axs[0].set_extent([145., 148, -39.2, -36.5])   #Gippsland
    ...
    axs[1].set_xlabel('')
    axs[1].set_ylabel('')
    axs[1].set_title('Prior to change', size=16)
...
#    axs[1].set_extent([140.8,144.7,-37.0,-33.8])  #Mallee
    axs[1].set_extent([140.8,144.7,-37.6,-33.8])   #Mallee+Wimmera
...
#    axs[1].set_extent([140.8,146.5,-39,-33.8])   #Western two thirds Vic
#    axs[1].set_extent([140.8,149.9,-39,-33.8])   #All Vic
#    axs[1].set_extent([140.8,142.9,-38.6,-37.1])  #Far southwest
#    axs[1].set_extent([145., 148, -39.2, -36.5])   #W&S Gippsland
    ...
    max_fbi2 = max_fbi2.interp(latitude = max_fbi1.latitude, longitude=max_fbi1.longitude, method='nearest')
    difference_fbi = max_fbi2 - max_fbi1
    
    im3 = difference_fbi.plot(ax=axs[2], transform=ccrs.PlateCarree(),vmin=-30., vmax=30., cmap='RdYlGn_r', add_colorbar=False)
    cb3 = plt.colorbar(im3, orientation='vertical', fraction=0.058)
    cb3.ax.tick_params(labelsize=12)
    areas_shapefile.plot(ax=axs[2], facecolor="none")
    axs[2].coastlines()
    axs[2].set_title('Diff old - new', size=16)
#    axs[2].set_extent([140.8,144.7,-37.0,-33.8]) #Mallee
    axs[2].set_extent([140.8,144.7,-37.6,-33.8])   #Mallee+Wimmera
...
#    axs[2].set_extent([140.8,146.5,-39,-33.8])   #Western two thirds Vic
#    axs[2].set_extent([140.8,149.9,-39,-33.8])   #All Vic
#    axs[2].set_extent([140.8,142.9,-38.6,-37.1])  #Far southwest
#    axs[2].set_extent([145., 148, -39.2, -36.5])   #W&S Gippsland

#    plt.savefig("fbi_recalc_"+str(year_sel_)+mon_sel_str+day_sel_str+"_kbdi40_day "+str(forecast_day)+"_.png")
    
plot_and_compare_fbi(max_recalc_fbi, max_fbi2, shp_in, forecast_day)
